...
describe("This will test different calculations", function() {
  it("this will count the number packets need for the apples", function() {
    const apple_instance = apple_factory();
  ...
  it("this will count the price per apple", function() {
    const apple_instance = apple_factory();
    ...
    assert.equal(0.44, apple_instance.cost_per_apple())
  })
  it("this will count the price per packet", function() {
    const apple_instance = apple_factory();
